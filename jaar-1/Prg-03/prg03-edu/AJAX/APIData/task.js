...
/**
 * Handle the click on the initial button to load the data
 */
function loadButtonClickHandler() {
    ajaxRequest(apiUrl, getPokemonsSuccessHandler);
}
...
function getPokemonsSuccessHandler(data) {
    ...
    //Loop through data and create a li element per Pokémon
